...
# Sustituye <usuario>, <password>, <host>, <puerto> y <nombre_bd> por tus valores reales
app.config['SQLALCHEMY_DATABASE_URI'] = (
    "postgresql://postgres:Yuls0106*@proyecto-integrador-db.c1igsysgu6ve.us-east-2.rds.amazonaws.com:5432/postgres"
)
db.init_app(app)
...
def reenviar_codigo():
    ...
    if usuario:
        ...
        db.session.commit()
        # Aquí deberías enviar el nuevo código por correo
        flash('Nuevo código enviado. Revisa tu correo.', 'info')
    else:
        flash('No se encontró el usuario para reenviar el código.', 'danger')
